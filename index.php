...
<head>
  ...
  <!-- Sweet Alert -->
  <link rel="stylesheet" type="text/css" href="vendor/sweetalert/dist/sweetalert2.min.css">
...
<body id="page-top">
  ...
  // Fetch all dosen from database
  $result = mysqli_query($connection, "SELECT * FROM dosen ORDER BY nip");

  // Fetch all mahasiswa from database
  $result_mahasiswa = mysqli_query($connection, "SELECT * FROM mahasiswa, program_studi WHERE mahasiswa.id_program_studi = program_studi.id_program_studi ORDER BY nrp ASC");
  ?>
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal1">
            ...
            <center><img class="img-fluid" src="img/group.png" alt=""></center>
          </div>
        </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-8 mx-auto">
          ...
          <form action="controller_message.php" method="post" novalidate="novalidate">
                    ...
                    <tbody>
                      ...
                      while($data_dosen = mysqli_fetch_array($result)) {
                        ...
                        echo "<td>
                          ...
                          <a class='btn btn-danger' onclick='deleteConfirm(event)' href='delete_dosen.php?nip=$data_dosen[nip]'><i class='fas fa-trash fa-fw'></i>Delete</a></td></tr>";        
                      }
                      ?>
                    </tbody>
                  </table>
                ...
                <div>
                  <table class="table table-striped">
                    ...
                    <tbody>
                      <?php
                      $no = 1;
                      while($data_mahasiswa = mysqli_fetch_array($result_mahasiswa)) {
                        echo "<tr>";
                        echo "<td>".$no++."</td>";
                        echo "<td>".$data_mahasiswa['nrp']."</td>";
                        echo "<td>".$data_mahasiswa['nama_depan']." ".$data_mahasiswa['nama_belakang']."</td>";
    ...
    function deleteConfirm(ev) {
      ...
      Swal.fire({
        ...
        if (result.value) {     
          ...
          Swal.fire('Anda membatalkan untuk menghapus!')
        }
      });
    }
  </script>
