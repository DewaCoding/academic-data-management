...
<body id="page-top">
  ...
  if (isset($_POST['update'])) {
    ...
    echo '<div class="alert alert-primary" role="alert"> Data dosen berhasil diperbarui !
    </div>';
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#edit-user">Edit Dosen</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <br>
  <!-- Contact Section -->
  <section class="page-section" id="edit-user">
    <div class="container">
